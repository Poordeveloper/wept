...
var Reporter = function(e) {
    ...
    var B = function(e) {
      ...
      L = {
        ...
        getLocation: function(e) {
          (0, u.invokeMethod)("getLocation", e)
        ...
        replaceState: function(e) {
          (0, u.invokeMethod)("replaceState", e)
        },
  ...
  __appServiceEngine__ = function(e) {
    ...
    myWeixinJSBridge.on("onShareAppMessage", (0, c.surroundByTryCatch)(P, "onShareAppMessage"));
    t.reset = function() {
      l = void 0, d = {}, p = {}, h = [], v = 0
    ...
    var o = n(1),
      ...
      c = function(e, t) {
        if ("start" !== e.action && "start_and_report" !== e.action || (s[e.eventID] = {
          ...
          "report" !== e.action && "start_and_report" !== e.action || ! function() {
            ...
            }), s[e.eventID].data = t, console.log("reportRealtimeAction"), console.log(s[e.eventID]), myWeixinJSBridge.invoke("reportRealtimeAction", {
      ...
      f = (t.triggerAnalytics = function(e, t) {
        ...
        if (e) {
          ...
          }), 0 !== o.length && myWeixinJSBridge.publish("analyticsConfig", {
            data: o
          }, [e.__wxWebviewId__]))
        }
      });
