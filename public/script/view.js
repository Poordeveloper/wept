...
var Reporter = function(e) {
    ...
    function r() {
      !E || E.length <= 0 || (o("reportKeyValue", {
        dataArray: E
      }), E = [])
    }

    function a() {
      !S || S.length <= 0 || (o("reportIDKey", {
        dataArray: S
      }), S = [])
    }
    ...
    "function" == typeof logxx && logxx("reporter-sdk start"), o("getPublicLibVersion", {}, function(e) {
      try {
        I = e.version.appVersion + " " + e.version.libVersion
      } catch (e) {}
    });
    var O = "ios" === l(),
      J = ("devtools" === l(), function() {}),
      H = {
        ...
        slowReport: function(e) {
          var t = e.key,
            ...
            r = u.SlowValueType[t],
            a = Date.now();
          if (r && (o || !(a - F < _)) && !(Object.keys(L).length > k || (L[i] || (L[i] = 0), L[i]++, L[i] > x))) {
            F = a;
        ...
        speedReport: function(e) {
          var t = e.key,
            ...
            i = e.timeMark,
            o = e.force,
            r = u.SpeedValueType[t],
            a = Date.now(),
            s = 0,
            l = i.nativeTime;
          if (r && (o || !(a - (R[r] || 0) < A)) && i.startTime && i.endTime && (1 != r && 2 != r || l)) {
            n && (s = JSON.stringify(n).length), R[r] = a;
        ...
        reportKeyValue: function(e) {
          var t = e.key,
            n = e.value,
            i = e.force;
          u.KeyValueType[t] && (!i && Date.now() - B < v || (B = Date.now(), E.push({
            key: u.KeyValueType[t],
            value: n
          }), E.length >= p && r()))
        },
        reportIDKey: function(e) {
          var t = e.id,
            n = e.key,
            i = e.force;
          u.IDKeyType[n] && (!i && Date.now() - D < m || (D = Date.now(), S.push({
            id: t ? t : O ? "356" : "358",
            key: u.IDKeyType[n],
            value: 1
          }), S.length >= h && a()))
        ...
        errorReport: function(e) {
          ...
          if (u.ErrorType[t]) {
            ...
            if (console.error(l), "undefined" != typeof window && "undefined" != typeof window.__webviewId__ ? myWeixinJSBridge.publish("WEBVIEW_ERROR_MSG", {
              ...
              }) : H.triggerErrorMessage(l), !(Object.keys(M).length > C)) {
              var c = u.ErrorType[t] + "," + n.name + "," + encodeURIComponent(o) + "," + encodeURIComponent(n.stack) + "," + encodeURIComponent(I);
              M[c] || (M[c] = 0), M[c]++, "thirdScriptError" === t && M[c] > w || M[c] > y || (H.reportIDKey({
                key: t
              }), H.reportKeyValue({
                key: "Error",
                value: c
        ...
        log: function(e, t) {
          e && "string" == typeof e && (!t && Date.now() - P < b || (P = Date.now(), T.push(e + ""), T.length >= g && s()))
        },
        submit: function() {
          Date.now() - N < f || (N = Date.now(), a(), r(), s())
        },
  ...
  exparser = function(e) {
    ...
    g.create = function(e, t, n, r) {
      ...
      var f = !1,
        ...
        S = [];
      v(S, h.childNodes, [], u), f || S.push(c), 1 === S.length && S[0] === c && S.pop();
      var T = Object.create(g.prototype);
      return T._tagTreeRoot = S, T._renderingMode = s, T
...
"ios" === wx.getPlatform() && window.exparser.registerElement({
  ...
  function(e) {
    ...
    wx.onAppDataChange((0, u.catchError)(function(e) {
      y.dataReady = !0, y.funcReady ? S(e) : x.push(e)
    ...
    var S = function(e) {
      if (y.firstRender) setTimeout(function() {
        var t = Date.now();
        E(e), o("reRenderTime", t, Date.now()), document.dispatchEvent(new CustomEvent("pageReRender", {}))
      }, 0);
      else {
        var t = Date.now();
    ...
    var r = function() {
      ...
      u = (n(3), function() {
        function e(t, n, i, r, s, l) {
          o(this, e), this.tagName = t || "div", this.props = n || {}, this.children = l || [], this.newProps = i || [], this.wxVkey = s, (0, a.isUndefined)(r) ? this.wxKey = void 0 : this.wxKey = String(r), this.descendants = 0;
    ...
    var i = n(2),
      o = (t.listDiff = function(e, t) {
        ...
        for (var y = u.slice(0), x = 0, C = [], k = [], E = 0; E < t.length;) {
          for (var S = t[E], T = r(S), I = y[x], B = r(I); null === I;) C.push(n(y, x, B)), I = y[x], B = r(I);
          B === T ? (++x, ++E) : T ? (B ? c[B] === E + 1 ? k.push({
            key: T,
            index: E
